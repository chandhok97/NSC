...
public class ContractorCarDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contractor_car_display);
        ...
        recyclerView= (RecyclerView) findViewById(R.id.rvContCarName);
       ...
       carsDisplayAdapter.setOnItemClickListener(new CarsDisplayAdapter.OnItemClickListener() {
           ...
           public void onclick(Integer position) {
               Intent i=new Intent(ContractorCarDisplay.this,ContractorDesignDisplay.class);
